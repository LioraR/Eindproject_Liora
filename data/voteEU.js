...
window.onload = function() {
    ...
    //     turnout = []
    //
    //     //var amountPoints = 13*28 (jaren*alle landen)
    //     for (var i = 0; i<364; i++) {
    //       //var years = Object.keys(vote[allCountries[i]])
    //       //console.log(years)
    //       if ((Object.values(vote[allCountries[i]])) == null) {
    //            delete Object.values(vote[allCountries[i]])
    //            console.log(Object.values(vote[allCountries[i]]))
    //
    //
    //       //if (Object.values(freedomHouse[allCountries[i]]) == null) {
    //       //    delete Object.values(freedomHouse[allCountries[i]])
    //
    //       //if (Object.keys(vote[allCountries[i]]) == null) {
    //       //  delete Object.keys(vote[allCountries[i]])
    //
    //
    //       turnout.push([Object.values(freedomHouse[allCountries[i]]), Object.values(vote[allCountries[i]]), allCountries[i], Object.keys(vote[allCountries[i]])])
    //       console.log(Object.values(vote[allCountries[i]]))
    //
    //
    // }
